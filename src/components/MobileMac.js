...
const MobileMac = ({src}) => {
    return (
        <svg className="mac" viewBox="0 0 100 83" version="1.1" xmlns="http://www.w3.org/2000/svg">
            ...
            <foreignObject className="screen" x="4" y="4" width="92" height="53" >
                <img src={src} alt="" />    
            </foreignObject>
        </svg>
    )
