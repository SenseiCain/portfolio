...
const Mac = props => {
    return (
        <svg id="mac" viewBox="0 0 100 83" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve">
